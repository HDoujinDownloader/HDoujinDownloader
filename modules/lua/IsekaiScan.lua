...
function Register()
    ...
    module.Domains.Add('ksgroupscans.com', 'KS Scans')
    ...
    module.Domains.Add('latan.visorsmr.com', 'Samurai')
    ...
    module.Domains.Add('mh.cookni.net', 'MHScans')
    ...
    module.Domains.Add('traduccionesamistosas.eyudud.net', 'Nartag')
