...
function GetPages()
    ...
    local apiResponse = http.Get('https://api-global.tappytoon.com/chapters/'..chapterId..'?includes=images&locale='..locale)

    pages.AddRange(Json.New(apiResponse).SelectValues('images[*].url'))
