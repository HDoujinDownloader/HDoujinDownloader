function Register()
    ...
    module.Domains.Add('3hentai.net')
...
function GetPages()
    ...
    for thumbnailUrl in dom.SelectValues('//div[@id="thumbnail-gallery"]//img/@data-src') do

        local fullImageUrl = thumbnailUrl
        
        if(module.Domain ~= '3hentai.net') then
