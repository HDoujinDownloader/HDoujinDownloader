...
function GetInfo()
    ...
    if(IsTagPage()) then
        ...
        info.Tags = dom.SelectValues('(//div[contains(h5/text(), "Genre") or contains(h5/text(), "Tag(s)") or contains(h5/text(), "Kategori") or contains(h5/text(), "Tür") or contains(h5/text(), "Género(s)") or contains(h5/text(), "Genero(s)")])[1]/following-sibling::div//a')
